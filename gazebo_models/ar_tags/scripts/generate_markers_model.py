...
dest_marker0 = os.path.join(args.gazebodir, "marker0")
if os.path.exists(dest_marker0):
    shutil.rmtree(dest_marker0)
shutil.copytree(os.path.join(model_dir, 'marker0'), dest_marker0)
...
for image_file in file_list:
    ...
    if not filename_without_ext.lower() == 'marker0':
        dest_path = os.path.join(args.gazebodir, filename_without_ext.lower())
        if os.path.exists(dest_path):
            shutil.rmtree(dest_path)
        shutil.copytree(os.path.join(args.gazebodir, "marker0"), dest_path)
    ...
    shutil.copy(image_file_path, image_dest_path)
    ...
    shutil.copy(model_noversion_sdf_path, model_sdf_path)
